...
class PagerViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        let p0 : ContentViewController = (self.storyboard?.instantiateViewControllerWithIdentifier("pageOne"))! as! ContentViewController
        p0.pageIndex = 0
        let p1 : ContentViewController = (self.storyboard?.instantiateViewControllerWithIdentifier("pageOne"))! as! ContentViewController
        p1.pageIndex = 1
